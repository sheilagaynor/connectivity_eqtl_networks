...
do
    ...
    do
     python /ldsc_2020/ldsc.py \
      ...
      --w-ld-chr /ldsc_2020/ldsc/1000G_Phase3_weights_hm3_no_MHC/weights.hm3_noMHC. \
      --overlap-annot \
      --print-coefficients \
      --print-delete-vals \
...
do
    ...
    do
     python /ldsc_2020/ldsc.py \
      --h2 /sumstats/$SUMSTAT \
      --ref-ld-chr /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/qval_snp_baselineLD.',/GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/qval_snp_degree_annot.' \
      --frqfile-chr /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/qval_snp_1000G.EUR.QC.' \
      --w-ld-chr /ldsc_2020/ldsc/1000G_Phase3_weights_hm3_no_MHC/weights.hm3_noMHC. \
      --overlap-annot \
      --print-coefficients \
      --print-delete-vals \
      --out /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/qval_snp_baseline.degree_annot.'$SUMSTAT
     done
done
...
do
    ...
    do
     python /ldsc_2020/ldsc.py \
      --h2 /sumstats/$SUMSTAT \
      --ref-ld-chr /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/lfdr_snp_baselineLD.',/GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/lfdr_snp_degree_annot.' \
      --frqfile-chr /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/lfdr_snp_1000G.EUR.QC.' \
      --w-ld-chr /ldsc_2020/1000G_Phase3_weights_hm3_no_MHC/weights.hm3_noMHC. \
      --overlap-annot \
      --print-coefficients \
      --print-delete-vals \
      --out /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/lfdr_snp_baseline.degree_annot.'$SUMSTAT
     done
done

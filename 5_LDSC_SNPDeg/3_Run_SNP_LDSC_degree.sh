...
do
    ...
    do
     python ldsc.py \
      --h2 /sumstats/$SUMSTAT \
      --ref-ld-chr /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/baselineLD.',/GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/degree_annot.' \
      --frqfile-chr /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/1000G.EUR.QC.' \
      --w-ld-chr /ldsc/1000G_Phase3_weights_hm3_no_MHC/weights.hm3_noMHC. \
      --overlap-annot \
      --print-coefficients \
      --print-delete-vals \
      --out /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/baseline.degree_annot.'$SUMSTAT
     done
done
...
do
    ...
    do
     python ldsc.py \
      --h2 /sumstats/$SUMSTAT \
      --ref-ld-chr /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/degree_annot.' \
      --frqfile-chr /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/1000G.EUR.QC.' \
      --w-ld-chr /ldsc/1000G_Phase3_weights_hm3_no_MHC/weights.hm3_noMHC. \
      --overlap-annot \
      --print-coefficients \
      --print-delete-vals \
      --out /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/degree_annot.'$SUMSTAT
     done
done

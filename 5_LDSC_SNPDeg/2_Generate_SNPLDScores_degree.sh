...
do
  ...
  do
    python ldsc.py \
    --l2 \
    --bfile /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/1000G.EUR.QC.'$CHR \
    --ld-wind-cm 1 \
    --annot /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/degree_annot.'$CHR'.annot.gz' \
    --out /GTEX_V8/Data/LDSC_SNPDegree_Bin/$TISSUE'/degree_annot.'$CHR
  done
done
